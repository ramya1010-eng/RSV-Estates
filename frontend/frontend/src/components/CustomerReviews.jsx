    ...
    <section className="testimonials" id="customer-reviews" style={{ paddingTop: '2rem' }}>
      <div className="container">
        ...
        >
          ...
          <p className="head-sub">CUSTOMER REVIEWS</p>
          <h2 className="section-title serif">What Our Clients Say</h2>
        </motion.div>
        ...
        >
          ...
          >
            See All Reviews <ArrowRight size={16} style={{ marginLeft: '6px', verticalAlign: 'middle' }} />
          </button>
        </motion.div>
